...
export const PorQueElegirnos = ()=> {
    ...
    <div className="flex flex-col  md:flex-row w-full h-screen ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-4 md:grid-rows-3 w-6/7 h-7/8 md:w-full md:h-full gap-6  md:pt-60 md:pl-20 md:pl-10 md:pr-35 md:pb-35 ">
            <div id="dataCard"  className="md:w-full md:h-full  md:grid-cols-2 grid grid-rows-1 gap-6 rounded-3xl   justify-center text-white ">
