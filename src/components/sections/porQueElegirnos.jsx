...
const imageVariants = {
  ...
  top: { hidden: { y: -100, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } },
  bottom: { hidden: { y: 100, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } },
};
...
export const PorQueElegirnos = () => {
  ...
  return (
    <section id="¿Por-Que-Elegirnos?" ref={ref} className="w-screen h-screen">
      <div className="flex flex-col md:flex-row w-full h-screen overflow-hidden">
        ...
        <div className="md:w-1/2 w-full h-screen flex items-center justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-3 w-6/7 h-7/8 md:w-full md:h-full gap-6 md:pt-60 md:pl-10 md:pr-35 md:pb-35">
            ...
            <div className="w-full h-full bg-[rgba(92,41,112,1)] rounded-3xl hidden md:flex" />
            ...
            <div className="w-full h-full bg-[rgba(28,15,33,1)] rounded-3xl hidden md:flex" />
