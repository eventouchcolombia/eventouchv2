...
export const CasosDeExito = ()=> {
    return(
        ...
        <div className="flex flex-col  md:flex-row w-full h-screen ">
            <div className=" flex flex-col   md:h-screen w-full md:w-2/3 justify-center  px-6   md:pl-110 pl-12 md:pr-29 pr-12 pt-40 md:pt-20 gap-16 md:gap-10   ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-4 md:grid-rows-2 w-6/7 h-7/8 md:w-full md:h-full gap-8  md:pt-78 md:pl-20 md:pl-10 md:pr-35 md:pb-55 ">
                <div id="dataCard" className="md:w-full md:h-full  bg-[rgba(28,15,33,1)] rounded-4xl flex flex-col items-center justify-center text-white p-12">
                ...
                <div id="dataCardWhite" className="w-full h-full bg-[rgba(92,41,112,1)] rounded-4xl flex flex-col items-center justify-center text-white p-12">
                ...
                <div id="dataCard" className="w-full h-full bg-[rgba(28,15,33,1)] rounded-4xl flex flex-col items-center justify-center text-white p-12">
